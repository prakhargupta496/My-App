...
function App() {
  ...
  const companies = [{name:"Amazon",title:"Software Engineer",expReq:2, location:"Bangalore", jobDescription:lorem }, {name:"Flipkart",title:"Software Engineer",expReq:2, location:"Bangalore", jobDescription:lorem }, 
    ...
    <div className="App">
      ...
      <Grid container columnSpacing={35} rowSpacing={5} >
        {companies.map((company) => (
          <Grid item md={4}>
            <Card name={company.name} title={company.title} jobDescription={company.jobDescription}/>
          </Grid>
        ))}
      </Grid>
